...
1. **进行中：继续A并弄清变化。** 从完整A900精确续训，预注册1200／1500／1800三个节点，
   ...
   当前300／600／900／1200／1500／1800 correct为99／88／140／135／112／122，train36／47／54／62／56／63。
   1800主面板已审计且有反弹，因此已登记2100；1800剩余视频对照完成后自动接续，累计8400条件／176400queries。
   此后依据多个完整节点的train／validation差距和成功集判断明显过拟合，单次回落不停止。
   每新节点保持原配方和完整评测，重核quota及事件／恢复连续性；不使用controls决定续训，具体判断见active design。
   A900视频对照为140／136／116／48／128／139。
