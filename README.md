...
**新科学主讨论已接管；首帧学习对照已完成并独立验收，新执行者已接手Reader有界工程，正式学习未激活。**
...
下一候选仅激活原生条件Reader的有界工程准备，尚未独立验收；它是诊断教师假设，不是最终单LoRA部署方案。
主讨论与Owner指定的新执行者身份均已登记；Owner授权夜间渐进推进，先派Reader有界工程，实际接手状态见progress。
...
| [Findings](findings.md) | 编号的跨轮发现；跨会话先读§156长期错误与两类循环约束、§157–158机制审查与§159首帧学习裁决，再按问题追溯§135–155和更早证据 |
