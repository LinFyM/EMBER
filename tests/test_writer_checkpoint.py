...
FAMILY = "k4_phase_aligned_language_axial_rawfull24_v1"
...
def _checkpoint(tmp_path: Path, contract_reference: str) -> Path:
    ...
    write_json_atomic(
        ...
        {
            "schema_version": K4_PHASE_ALIGNED_LANGUAGE_AXIAL_CHECKPOINT_SCHEMA,
...
def test_k4_checkpoint_uses_schema_and_sizes_without_content_hashing(tmp_path: Path) -> None:
    reference = "ember_pi05_k4_phase_aligned_language_axial_semantic_procedure_launch_v1"
