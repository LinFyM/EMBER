...
4. **进行中：有界后续与分析。** other140/159/165全部完成，主候选冻结1500；执行唯一监督配对消融及冻结后controls。
   Owner追加观察后续趋势：完成现有窗口后，两臂保留完整1500训练状态，各继续至2100；1800/2100 correct400/train96，2100双方other400。
   固定尾段LR、原采样流和物理拓扑，新增窗口单独报告，不改写原选择。本轮不补双相机，不开展无依据扫描。
