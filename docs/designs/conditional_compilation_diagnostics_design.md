...
主讨论`01a0cd94-65da-7b22-8ca9-7ba35f454632`、Sol执行任务`01a0cd90-ebb7-77a1-a20b-a858825d2f66`已登记在registration/spec。
实际派发与执行状态见progress及study协调回执；原Luna已经停止，旧任务ID只作历史provenance，不能据旧示例自动联系。
