...
def _writer_contract_inputs(tmp_path: Path) -> tuple:
    ...
    shared_writer = {
        ...
        "config": {
            ...
            "schema": (
                "ember_pi05_layer_matched_memory_program_compiler_writer_v5"
            ),
        },
        "writer_asset": {
...
def test_sealed_dynamic_k_writer_requires_profile_supported_batch(
    ...
    shared_writer.update(
        schema_version="ember_pi05_layer_matched_memory_program_compiler_eval_adapter_v5",
        kind="layer_matched_memory_program_compiler_writer",
    )
    shared_writer["config"] = {
        ...
        "schema": "ember_pi05_layer_matched_memory_program_compiler_writer_v5",
    }
