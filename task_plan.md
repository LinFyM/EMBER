...
6. **进行中：** R已通过原拓扑完整200恢复，300 strict400=63（200为83），相邻保留43/新增20/丢失40；400训练与独立动作验证已完成，FM=.105399，strict400正在评测、train96随后衔接；此前37→83的获取尚未持续，按active design§8在累计102400queries与旧off400作等动作曝光终点比较。仅追加R，C/S不追加，不新增架构。
