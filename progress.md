...
- main50/100/200/300所有train96及validation400 correct/other面板均完成；main300 train43/46、validation32/32。frame_set50/100全部面板完成，frame_set200 train46/47、validation correct69完成，其validation other仍在gpu02:6运行。frame_set已按原gpu02:1,3完成300步并释放训练卡；全部1,200条件/76,800queries与main实际曝光匹配，完整checkpoint保留。frame_set300材料已在gpu01:5生成中，当前仅2张（gpu01:5、gpu02:6）；300步四面板在材料就绪后继续。
