...
V6_PRIOR_CHECKPOINT_SCHEMA = (
    "ember_pi05_v6_counterfactual_null_program_residual_checkpoint_v1"
)
V6_PRIOR_RNG_SCHEMA = (
    "ember_pi05_v6_counterfactual_null_program_residual_rank_rng_v1"
)
V6_PRIOR_CHECKPOINT_INSPECTION_SCHEMA = (
    "ember_pi05_v6_counterfactual_null_program_residual_inspection_v1"
)
