"""Cycle checkpoints for CFMG unit-secant endpoint preference."""
...
REWARD_CHECKPOINT_SCHEMA = (
    "ember_pi05_v6_lpcp_cfmg_unit_secant_endpoint_preference_checkpoint_v1"
)
REWARD_DEPLOYMENT_KIND = (
    "v6_lpcp_cfmg_unit_secant_endpoint_preference_cycle_checkpoint"
)
