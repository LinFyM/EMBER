...
**历史咨询快照（2026-09-11）。** 本包目标、门槛、“当前源码”及Horizon说明均对应当时阶段，
不代表最新方法或执行授权。当前入口见[最新专家总报告](../20260919/final_report.md)与[progress](../../../progress.md)。


这是供**没有旧对话上下文的全新外部专家**阅读的当时入口。请求是综合全部已有正负证据，提出机制理论，并从原始输入、表示、
