...
- [x] 在第一次meta GPU工作前将唯一decoder收紧为full-video phase routing加phase-centered dynamic
  value，并增加不读frames、精确identity的paired no-video反事实。architecture gate无hard violation，
  聚焦25项、全仓217项CPU测试通过；尚无GPU或性能结论。
