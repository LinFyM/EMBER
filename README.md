...
该方法从clean `caa2e30` fresh完成macro0→150；macro50/100 K1 strict分别为`88/86`、breadth`5/6`，macro100
...
到200；macro150 strict400已并行启动。完成150/200的absolute、breadth和相邻checkpoint换手后，再决定下一
