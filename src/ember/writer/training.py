...
RUN_SCHEMA = "ember_horizon_causal_sharing_run_v1"
STAGE = "horizon_causal_sharing_exploratory"
...
def _config(path: Path) -> dict[str, Any]:
    ...
    expected_model = asdict(HorizonWriterConfig(decoder_rank_sharing=config["model"].get("decoder_rank_sharing", "")))
