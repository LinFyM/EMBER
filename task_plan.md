...
- [x] 完成full24×50 feature dynamics与expert-target只读CPU审计：发现`.98057`中位phase-DC静态
  捷径，但temporal residual保留强ordered/reversed信息且与expert B geometry相关；3/5-shot proxy
  相对one-shot只小幅增加，首轮继续one-shot。
...
- implementation/config seal为clean pushed`c33a16b`：不再使用DDP model wrapper；每rank保持
  microbatch1与4-task local mean，再按固定parameter order做一个flat-gradient Ring/Simple NCCL
  all-reduce mean。聚焦49/49、全仓223/223，architecture guard无hard/parallel family。formal仍blocked。
- 设备仍为启动前live空闲`gpu01:0,1,2|4,5,7`的3+3 NUMA。fresh/resume与contiguous roots固定为
  `runs/outputs/pi05_expert_manifold_writer_flatreduce_profile_r6_step2000_c33a16b_20260809`和
  `runs/outputs/pi05_expert_manifold_writer_flatreduce_profile_contiguous_r6_step2000_c33a16b_20260809`；
  logs同basename位于`runs/logs/`，tmux为`ember_expert_manifold_flatreduce_profile_c33a16b`与
  `ember_expert_manifold_flatreduce_contiguous_c33a16b`。全部启动前不存在，旧roots不得resume。
- exact commands：

```bash
env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 NCCL_ALGO=Ring NCCL_PROTO=Simple OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_flatreduce_profile_r6_step2000_c33a16b_20260809 --stop-after-macro 1

env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 NCCL_ALGO=Ring NCCL_PROTO=Simple OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_flatreduce_profile_r6_step2000_c33a16b_20260809 --stop-after-macro 3 --resume /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_flatreduce_profile_r6_step2000_c33a16b_20260809/checkpoints/macro_00000001

env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 NCCL_ALGO=Ring NCCL_PROTO=Simple OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_flatreduce_profile_contiguous_r6_step2000_c33a16b_20260809 --stop-after-macro 3
```

- exact门：三步scientific metrics逐值相同，macro1全部checkpoint state与macro3 Writer逐字节一致；
...
- 输入固定为flat profile macro3、validation 8 tasks×1 state、correct video、without-replacement；一个
  ...
  cached rollout。首次root
  `runs/outputs/pi05_expert_manifold_writer_macro0003_online_smoke_gpu02_c33a16b_20260809`在CPU-only prepare
  因formal/smoke `source_run_summary`表示差异fail-close，0 CUDA worker/0 row，已ABORTED且不得resume。
  scoped repair保持其他source字段精确并现场校验training summary path/bytes/schema，聚焦58/58、全仓
  224/224；replacement fresh root固定为
  `runs/outputs/pi05_expert_manifold_writer_macro0003_online_smoke_r2_gpu02_c33a16b_20260809`。
- exact command（从clean pushed safety worktree执行）：

```bash
env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID NCCL_P2P_DISABLE=1 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 EMBER_LIBERO_ASSETS_ROOT=/data1/user/ymdai/projects/EMBER/data/simulation/ember_assets/datasets/libero-assets/0b3ea86be5fe169d0fd036ae63d1070ec09e90f6 /data1/user/ymdai/projects/EMBER/.venv/bin/python scripts/evaluate_pi05.py run --config configs/pi05_target_evaluation_v1.json --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --tokenizer-path /data1/user/ymdai/projects/EMBER/models/tokenizers/openpi/paligemma_tokenizer.model --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_macro0003_online_smoke_r2_gpu02_c33a16b_20260809 --role validation --mode smoke --state-count 1 --replicas-per-gpu 3 --writer-generators-per-gpu 1 --writer-generation-batch-size 4 --gpu-indices 0 --expert-manifold-config configs/pi05_video_expert_manifold_v1.json --expert-manifold-checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_flatreduce_profile_r6_step2000_c33a16b_20260809/checkpoints/macro_00000003 --expert-manifold-video-data-root /data1/user/ymdai/projects/EMBER/data/datasets/f13aa24a3da8c43c7225569f28c562979fa0e35a --expert-manifold-video-condition correct --expert-manifold-video-sampling without_replacement
```
...
- working-root-cause修复seal为clean pushed`12727b8`：唯一数值变化是DDP固定
  `static_graph=True`、关闭immutable buffer broadcast及unused-parameter search；run contract新增
  `ddp_static_graph=true`与`ddp_broadcast_buffers=false`。模型、step2000 target、cache、loss、optimizer、
  scheduler、RNG、world6和task ownership都不变。聚焦CPU合同46/46通过。
- 设备仍固定实时空闲`gpu01:0,1,2|4,5,7`的3+3 NUMA；每段启动前重新检查。新fresh/resume与
  contiguous roots分别为
  `runs/outputs/pi05_expert_manifold_writer_staticgraph_profile_r6_step2000_12727b8_20260809`和
  `runs/outputs/pi05_expert_manifold_writer_staticgraph_profile_contiguous_r6_step2000_12727b8_20260809`，
  日志同basename位于`runs/logs/`，tmux为`ember_expert_manifold_staticgraph_profile_12727b8`及
  `ember_expert_manifold_staticgraph_contiguous_12727b8`；全部启动前必须不存在。
- exact commands：

```bash
env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_staticgraph_profile_r6_step2000_12727b8_20260809 --stop-after-macro 1

env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_staticgraph_profile_r6_step2000_12727b8_20260809 --stop-after-macro 3 --resume /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_staticgraph_profile_r6_step2000_12727b8_20260809/checkpoints/macro_00000001

env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_staticgraph_profile_contiguous_r6_step2000_12727b8_20260809 --stop-after-macro 3
```

- 验收不放宽：fresh/resume与contiguous三步scientific metrics精确一致，macro1全部checkpoint state及
  macro3 Writer逐字节一致；run contract逐rank NUMA/physical mapping正确，DDP两个新字段正确，0
  OOM/nonfinite。若仍分叉则否决static-graph解释并继续定位，不进入online smoke/formal。

### Expert-Manifold meta-Writer首次A40 profile launch合同（已否决，2026-08-09）

- 科学config/target seal为clean pushed`d96f0fb`：统一expert step2000、one-shot causal-prefix
  dynamic value、train24×50 sealed feature cache、formal仍blocked。实际运行checkout必须包含本段
  launch record且保持clean/pushed；run contract中的完整Git commit是执行provenance，root后缀
  `d96f0fb`只标识科学config seal。
- 00:01 CST live比较后固定`gpu01:0,1,2|4,5,7`，六卡均为空闲A40且满足3+3 NUMA；GPU3的
  `nlge` VLLM不触碰。gpu02物理6/7有他人进程且空闲0--5只能形成4+2，不使用。gpu01 available
  memory约516.5GB；`/data1` quota=`552,249,764/1,073,741,824 KiB`，三条profile root保守新增
  低于2GiB。每次启动前仍重看这六卡，任一卡变忙就延后或改用另一个合法3+3组合。
- fresh/resume root、contiguous root、日志和tmux固定为：
  `runs/outputs/pi05_expert_manifold_writer_profile_r6_step2000_d96f0fb_20260809`、
  `runs/outputs/pi05_expert_manifold_writer_profile_contiguous_r6_step2000_d96f0fb_20260809`、
  对应同basename的`runs/logs/*.log`、`ember_expert_manifold_profile_d96f0fb`与
  `ember_expert_manifold_profile_contiguous_d96f0fb`。所有root/log启动前必须不存在。
- 三条exact command均在frozen safety worktree执行，显式保持world6、physical/local映射、
  `NCCL_P2P_DISABLE=1`和deferred-NCCL：

```bash
env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_profile_r6_step2000_d96f0fb_20260809 --stop-after-macro 1

env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_profile_r6_step2000_d96f0fb_20260809 --stop-after-macro 3 --resume /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_profile_r6_step2000_d96f0fb_20260809/checkpoints/macro_00000001

env PYTHONPATH=$PWD/src CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=8 TOKENIZERS_PARALLELISM=false EMBER_STORAGE_ROOT=/data1/user/ymdai EMBER_STORAGE_CAP_BYTES=1099511627776 /data1/user/ymdai/projects/EMBER/.venv/bin/torchrun --standalone --nproc-per-node=6 scripts/train_expert_manifold_writer.py --config configs/pi05_video_expert_manifold_v1.json --mode profile --source-run /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722 --checkpoint /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_source_base_v1_seed7_1k_e2cc238_20260722/checkpoints/step_00001000 --expert-bank-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_task_expert_bank_formal_step1000_r6_81101fe_20260807 --expert-step 2000 --feature-cache-root /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_feature_cache_train24x50_r6_222d3ac_20260808 --output-dir /data1/user/ymdai/projects/EMBER/runs/outputs/pi05_expert_manifold_writer_profile_contiguous_r6_step2000_d96f0fb_20260809 --stop-after-macro 3
```

- 验收要求：三步finite、0 OOM、source trainable=0；run contract逐rank为local0--5→physical
  `0,1,2,4,5,7`、NUMA=`0,0,0,1,1,1`且affinity非空；fresh/resume与contiguous三步科学metrics精确
  一致，两个macro3 `writer.safetensors`逐字节一致（只用直接`cmp`，不用内容hash）；完整checkpoint/
  optimizer/scheduler/RNG/cursor闭合。任何失败都不得把profile权重用于formal。
