...
- main50/100/200/300所有train96及validation400 correct/other面板均完成；main300 train43/46、validation32/32。frame_set50/100全部面板完成，frame_set200 train46/47、validation correct69完成，其validation other仍在gpu02:6运行。frame_set训练继续原gpu02:1,3至登记的300步；已结束面板自然释放卡位，当前本轮只剩3张（gpu02:1,3,6），没有新增占卡任务。frame_set300材料与四面板待完整checkpoint后继续。
