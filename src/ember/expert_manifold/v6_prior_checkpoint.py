"""Atomic Program-memory and success-key-bank checkpoints for Work-Queue PCUG."""
...
V6_PRIOR_CHECKPOINT_SCHEMA = (
    "ember_pi05_v6_work_queue_candidate_update_guard_checkpoint_v1"
)
V6_PRIOR_RNG_SCHEMA = (
    "ember_pi05_v6_work_queue_candidate_update_guard_rank_rng_v1"
)
V6_PRIOR_CHECKPOINT_INSPECTION_SCHEMA = (
    "ember_pi05_v6_work_queue_candidate_update_guard_inspection_v1"
)
