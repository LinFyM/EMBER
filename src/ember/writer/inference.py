...
WRITER_ADAPTER_SCHEMA = "ember_pi05_language_axial_writer_eval_adapter_v5_3"
RL_WRITER_ADAPTER_SCHEMA = "ember_pi05_language_axial_rl_writer_eval_adapter_v5_3"
...
WRITER_EPISODE_EVIDENCE_V5_3 = "ember_pi05_writer_episode_evidence_v5_3"
...
def expected_writer_episode_evidence(
    ...
    *,
    ...
    expected_schema = (
        ...
        else WRITER_EPISODE_EVIDENCE_V5_3
    )
