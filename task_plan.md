...
5. **进行中：** off7受控续训600已结束，500 correct400=73（父400=126），600 correct400/train96待完成；保持探索性标记及迁移lineage，不自动继续600之后。
6. **已登记：** R仍有37→83的获取趋势，按active design§8从原200完整exact-resume至400，预登记300/400 correct400、400 train96/独立动作验证，在102400queries与旧off400作等动作曝光比较。仅追加R，C/S不追加，不新增架构。
