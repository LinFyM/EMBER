...
EXPECTED=107806f5f45146b928c3109d6bf27988fd732254
EXIT_FILE="$STUDY/launch/retry6_${NAME}.exit"
STDOUT_FILE="$STUDY/launch/retry6_${NAME}.stdout.log"
STDERR_FILE="$STUDY/launch/retry6_${NAME}.stderr.log"
