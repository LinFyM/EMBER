...
**成功信用方向试验已复核：P/R/NEG/FM为35/26/26/29，未兑现收益预测，不启动长程RL。** 下一项只复用原采集，检验夹爪同一开合指令内的随机幅度对完整Writer梯度的影响；无新训练或闭环。尚无经过验证的统一根因或修复。
...
| [Findings](findings.md) | 编号的跨轮发现；近期冻结诊断见§135–139，关系支持及后继映射/学习诊断见§140–147 |
