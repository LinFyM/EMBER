...
- main50/100/200/300所有train96及validation400 correct/other面板均完成；main300 train43/46、validation32/32。frame_set50/100全部面板完成，frame_set200 train46/47、validation correct69完成，其validation other仍在gpu02:6运行。frame_set已按原gpu02:1,3完成300步并释放训练卡；全部1,200条件/76,800queries与main实际曝光匹配，完整checkpoint保留。frame_set300四套材料全部生成；其train correct在gpu01:6，validation correct在gpu01:4,5、other在gpu02:0,1，另有frame_set200 other在gpu02:6。当前共6张；两组300验证各6workers，训练诊断3workers，两组验证12workers均已就绪，300 train other在correct结束后接续。
