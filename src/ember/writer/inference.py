...
WRITER_ADAPTER_SCHEMA = "ember_pi05_unified_causal_program_writer_eval_adapter_v1"
...
WRITER_EPISODE_EVIDENCE_WITH_REPLACEMENT = (
    "ember_pi05_unified_causal_program_episode_evidence_with_replacement_v1"
)
WRITER_EPISODE_EVIDENCE_UCP = (
    "ember_pi05_unified_causal_program_episode_evidence_v1"
)
...
def expected_writer_episode_evidence(
    ...
    *,
    ...
    expected_schema = (
        ...
        else WRITER_EPISODE_EVIDENCE_UCP
    )
...
class FrozenWriterTaskAdapter(WriterLoRARolloutAdapter):
    ...
    def __init__(
        ...
        *,
        ...
        if kind == "rl_writer":
            raise WriterModelError(
                "RL-Writer requires retraining for the canonical UCP Writer"
            )
        if kind != "as_writer":
