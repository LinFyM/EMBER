...
profile及formal-seed fresh/exact-resume seal；正式fresh macro0→200正在pushed
clean `79fb7ee`的frozen worktree运行。当前精确参数为`10,633,216`。首个正式
macro已验证24-task/B20/one-video/CP同步合同，但尚无checkpoint行为性能证据。
