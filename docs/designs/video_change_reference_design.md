...
完整原件与解释见[机制复核§10](../analyses/video_mechanism_reassessment.md)。C100/200正确32→42、静态29→49、S30→51，各96；C200两错46、乱序45、source15。固定八task的语义S后正确/静态过程同为15/32。正确过程没有随能力获取出现净收益，局部参照修正具有可检验的具体对象；这不证明C收敛，也不保证新候选成功。
