...
6. **进行中：** R已通过原拓扑完整200恢复，300 strict400=63（200为83），相邻保留43/新增20/丢失40；400继续训练，此前37→83的获取尚未持续，按active design§8从原200完整exact-resume至400，预登记300/400 correct400、400 train96/独立动作验证，在102400queries与旧off400作等动作曝光比较。仅追加R，C/S不追加，不新增架构。
