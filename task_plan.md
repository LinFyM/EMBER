...
2. **下一项已登记：** 固定local开启，新增local_h_read与local_compiler两个fresh单入口对照，补足已有all/local_only的2×2矩阵，区分H-read、Compiler及其交互；具体共同协议、200/400节点、历史排重与裁决在`docs/horizon_causal_language_learning_20260909.md`末节。仅隔离探索，不自动正式采纳；实现/profile及资源合同通过后运行。
