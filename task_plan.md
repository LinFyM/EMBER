...
4. **短学习与行为（进行中：原96步已训完，48步6/5对source4；96步行为及单变量初始化对照）。** 预登记跨Spatial/Object/Goal及有实质专家容量Long的训练侧任务、跨episode角色、曝光和行为节点。
   Writer/Meta联合更新；原完整图保持，针对近常量B与非恒定真实梯度仅准备native坐标初始化fresh对照，见design§8.4。
