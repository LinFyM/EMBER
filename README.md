...
**新科学主讨论已接管；首帧学习对照已完成并独立验收，Reader未实施，没有新实验开跑。**
...
下一候选只登记原生条件Reader的有界工程准备，仍未实施；它是诊断教师假设，不是最终单LoRA部署方案。
新主讨论身份已登记于progress与Reader工程spec；等待Owner指定新执行者，在此之前不派发、不联系旧会话或催问创建时间。
...
| [Findings](findings.md) | 编号的跨轮发现；跨会话先读§156长期错误回顾、§157–158机制审查与§159首帧学习裁决，再按问题追溯§135–155和更早证据 |
