...
1. **进行中：继续A并弄清变化。** 从完整A900精确续训，预注册1200／1500／1800三个节点，
   ...
   当前300／600／900／1200／1500 correct为99／88／140／135／112，train36／47／54／62／56；1800训练已完成，正式面板待完成。
   1800若反弹则按300更新节点继续；依据多个完整节点的train／validation差距和成功集判断明显过拟合，单次回落不停止。
