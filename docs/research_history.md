...
`.983541/.985926`、held/train=`.960650x`通过，已解锁fresh full24。clean`a62348e`首次full24因旧formal只
保留view0而与global four-view commitment冲突，exit1且无checkpoint/completion；这是已最小修正的工程
合同错误，不是CMBG科学结果。
