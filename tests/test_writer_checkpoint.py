...
FAMILY = "k4_grounded_video_expert_policy_layer_trace_m2p_full24_v1"
...
def _checkpoint(tmp_path: Path, contract_reference: str) -> Path:
    ...
    write_json_atomic(
        ...
        {
            "schema_version": K4_GROUNDED_VIDEO_EXPERT_LAYER_TRACE_M2P_CHECKPOINT_SCHEMA,
...
def test_k4_checkpoint_uses_schema_and_sizes_without_content_hashing(tmp_path: Path) -> None:
    reference = "ember_pi05_k4_grounded_video_expert_policy_layer_trace_m2p_launch_v1"
