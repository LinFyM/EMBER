...
EXPECTED=7190bf0776826a9ebc1d4e13d70a1ece1c384f1a
EXIT_FILE="$STUDY/launch/retry2_${NAME}.exit"
STDOUT_FILE="$STUDY/launch/retry2_${NAME}.stdout.log"
STDERR_FILE="$STUDY/launch/retry2_${NAME}.stderr.log"
