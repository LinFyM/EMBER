...
## 完成登记（2026-09-18；不改写上述预注册）

正式fresh训练在1200停止，四节点及所有配对评测完成。validation set79/109/142/118，对A99/88/140/135；
train set33/40/49/57，对A36/47/54/62。主节点显示可达142但未在1200保住，不能宣布相邻等强或有序全面占优。
本设计已封存，不再是active design；[最终报告](review_materials/20260918/frameset_report.md)提供完整解释和可复核结果。
