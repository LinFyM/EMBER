#!/usr/bin/env bash
# Retry worker after the verified detached-code/asset-root repair; science contract is unchanged.
set -uo pipefail
...
EXPECTED=7fe99d30036541f1859ee6a7a9f1c90809714848
EXIT_FILE="$STUDY/launch/retry_${NAME}.exit"
STDOUT_FILE="$STUDY/launch/retry_${NAME}.stdout.log"
STDERR_FILE="$STUDY/launch/retry_${NAME}.stderr.log"
