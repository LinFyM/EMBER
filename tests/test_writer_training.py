...
def test_formal_is_sealed_only_by_fresh_evidence_factorized_profile() -> None:
    config = load_writer_config(CONFIG)
    ...
    assert evidence["step2_evidence_key_direction_physical_and_vector_fusion_reachable"] is True
