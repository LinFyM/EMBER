"""Canonical language/video Core + Procedure Writer and raw input preparation."""
...
ARCHITECTURE = "video_core_procedure_complete_lora"
MODEL_DEFAULTS = {
...
def require_architecture_identity(model: Mapping[str, Any]) -> None:
    ...
    if (set(model) != set(MODEL_DEFAULTS)
        ...
        raise ValueError("canonical Core/Procedure Writer architecture changed")
