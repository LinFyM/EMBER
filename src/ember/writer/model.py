"""Canonical Amplitude-Preserving Asymmetric Dual-Read PI05 Writer."""
    ...
    def __init__(
        ...
        *,
        ...
        if (
            ...
            raise WriterModelError("invalid AP-ADR Writer topology")
        ...
        self.compiler = AsymmetricDualReader(
            width=program_width,
