...
CHECKPOINT_SCHEMA = "ember_pi05_layer_matched_memory_program_compiler_checkpoint_v3"
DEPLOYMENT_CHECKPOINT_KIND = "layer_matched_memory_program_compiler_v3_macro_checkpoint"
