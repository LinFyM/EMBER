...
class AntitheticCodeCredit:
    """One paired finite-difference estimate in the Writer code coordinate."""
...
def trajectory_outer_score(
    ...
    *,
    ...
    """Combine terminal success with peak BDDL-goal progress on train tasks."""
...
def paired_antithetic_code_credit(
    ...
    *,
    ...
    return AntitheticCodeCredit(
        ...
        minus_progress_mean=sum(value[1] for value in minus_values) / len(minus_values),
    )
