...
**本包现为历史证据入口。全新专家请先读[视频特异性与综合理论重构](../video_specificity_20260911/README.md)。**
下文的“main/当前/下一步”描述`043b58ca`前后咨询时点，不代表最新源码或授权；旧包未包含R/C/S及随后完整机制和局部参照结果，
这些已在新包补齐。原专家回复保留原文供核对，不能覆盖Owner最新阶段目标或预设新方案。
