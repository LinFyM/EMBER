"""Configuration loading for the canonical K4 invariant-program M2P Writer."""
...
FEWSHOT_M2P_CONFIG_SCHEMA = "ember_pi05_k4_invariant_program_m2p_as_writer_v1"
...
def _validate_training(config: Mapping[str, Any]) -> None:
    ...
    required = {
        "method": "k4_video_value_invariant_program_policy_m2p_rawfull24",
