...
2. 新launch先刷新双节点GPU、独立quota及新增峰值，保持原world4/rank物理2/6/4/0和完整学习状态；复用已验证运行面与profile，不改科学配方或重复工程检查。当前同配方200→400训练已完整exit0、两个checkpoint与实际曝光核验通过；300评测和400物化/冻结诊断并行，实际进度见progress。
