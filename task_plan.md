...
4. **进行中：** R/C首轮训练、物化及两点validation400、train96已全部完成。R37→83、C43→50，train46/49；同预算旧off200为108和40，两项改动未见迁移净收益。C不追加，R待S证据再决定；S100评测、后半段训练及200物化/validation400/train96接续完成。报告全部曝光和逐task/suite得失。
