...
def test_sealed_dynamic_k_writer_requires_profile_selected_batch(
    ...
    shared_writer.update(
        schema_version="ember_pi05_v6_shared_core_procedure_common_value_bridge_eval_adapter_v1",
        kind="v6_shared_core_procedure_common_value_writer",
    )
    shared_writer["config"] = {
        ...
        "schema": "ember_pi05_v6_shared_core_procedure_common_value_bridge_as_writer_v1",
    }
    ...
    storage["parameter_count"] = 1_287_168
    storage["tensor_bytes"] = 2_641_920
    ...
    with pytest.raises(Pi05EvaluationError, match="selected Writer batch"):
        _build_writer_contract(
            ...
            arm="v6_shared_core_procedure_common_value_bridge_correct",
            condition="correct",
            mapping=correct_mapping,
            writer_generation_batch_size=16,
        )
