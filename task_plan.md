...
3. **进行中：50／100两等间隔节点已按实际吞吐在看分数前登记。** 有序组已在gpu02三卡从5116deb0 frozen正式启动，
   无序组在同节点三卡现场可用后独立fresh启动，保持两臂相同曝光；
...
当前唯一active design为语义状态路径Writer。真实纠正诊断已关闭，不扩大面板或扫描；有序正式训练与source400正在运行。
