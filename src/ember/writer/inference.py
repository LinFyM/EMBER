...
WRITER_ADAPTER_SCHEMA = "ember_pi05_amplitude_preserving_dual_read_writer_eval_adapter_v1"
...
WRITER_EPISODE_EVIDENCE_WITH_REPLACEMENT = (
    "ember_pi05_amplitude_preserving_dual_read_episode_evidence_with_replacement_v1"
)
WRITER_EPISODE_EVIDENCE_AP_ADR = (
    "ember_pi05_amplitude_preserving_dual_read_episode_evidence_v1"
)
...
def expected_writer_episode_evidence(
    ...
    *,
    ...
    expected_schema = (
        ...
        else WRITER_EPISODE_EVIDENCE_AP_ADR
    )
...
class FrozenWriterTaskAdapter(WriterLoRARolloutAdapter):
    ...
    def __init__(
        ...
        *,
        ...
        if kind == "rl_writer":
            raise WriterModelError(
                "RL-Writer requires retraining for the canonical AP-ADR Writer"
            )
        if kind != "as_writer":
