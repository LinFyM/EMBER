...
本次授权是整理相关材料、更新远程仓库并提供可复制prompt，由Owner转发给没有旧对话上下文的全新外部专家。
保留历史专家原文供追溯，但首先提供原始事实、正负证据及比较边界，不以旧专家建议或当前归因引导结论。
没有授权恢复训练、评测、95-task扩展或创建新goal；当前没有获准执行的新active design。
